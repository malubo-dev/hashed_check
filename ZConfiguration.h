...
#define ZTOK_DAMAGE_COUNTER				"DAMAGECOUNTER"	//Damage Counter
...
#define Z_ETC_DAMAGE_COUNTER	(ZGetConfiguration()->GetEtc()->bDisplayDamage)
#define Z_ETC_FLOAT_DAMAGE		(ZGetConfiguration()->GetEtc()->bFloatdmg)
