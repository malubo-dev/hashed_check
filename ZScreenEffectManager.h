...
class ZScreenEffect : public ZEffect{	// ȭ����ǥ�迡 �ѷ����� ����Ʈ (UI ����)
protected:
...
private:
	...
	RMesh*  m_pDmgPlusEffect; // Float Damage
	RMesh*  m_pDmgMinusEffect; // Float Damage
	RMesh*  m_pDmgNumberEffect[10]; // Float Damage
...
public:
	...
	void AddDamageEffect(int nDmg); // Float Damage
	...
	void AddPraise(int nPraise);	// Score�� ���󰡴� ����Ʈ
	void AddGood();
	void AddNice();
	void AddGreat();
	void AddWonderful();
